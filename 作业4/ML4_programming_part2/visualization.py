...
for i, clf in enumerate(demo_list):
    ...
    for index in range(len(clf.support_)):
        plt.scatter(X[clf.support_[index], 0], X[clf.support_[index], 1], c='g',  marker="o")
...
# If doing save after show, it will create a white file.
